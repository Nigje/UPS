...
namespace UPS.Framework.Exceptions
{
    public class UPSException : Exception
    {
        ...
        //***********************************************************************************************
        public UPSException(string message, string technicalMessage = "", string errorCode = null)
            : base(message)
        {
        ...
        //***********************************************************************************************
        public UPSException(string message, string technicalMessage, Exception innerException, string errorCode = null)
